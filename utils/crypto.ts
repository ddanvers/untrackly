...
export async function deriveSharedKey(privateKey: CryptoKey, publicJwk: JsonWebKey) {
...
export async function decryptData(key: CryptoKey, iv: Uint8Array, data: Uint8Array) {
  if (!(key instanceof CryptoKey)) {
